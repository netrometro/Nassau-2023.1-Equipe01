...
if ($conn->query($sql) === TRUE) {
  echo "Inserir cliente feito successfully".'<br>';
} else {
  echo "Error creating table: " . $conn->error.'<br>';
}
...
if ($conn->query($sql) === TRUE) {
  echo "Inserir usuario feito successfully".'<br>';
} else {
  echo "Error creating table: " . $conn->error.'<br>';
}
...
if ($conn->query($sql) === TRUE) {
  echo "Table titulos_receber created successfully".'<br>';
} else {
  echo "Error creating table: " . $conn->error.'<br>';
}
...
if ($conn->query($sql) === TRUE) {
  echo "Inserir titulos_receber feito successfully".'<br>';
} else {
  echo "Error creating table: " . $conn->error.'<br>';
}
...
// sql to create table
$sql = "CREATE OR REPLACE TABLE titulos_pagar (
  id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
if ($conn->query($sql) === TRUE) {
  echo "Table titulos_pagar created successfully".'<br>';
} else {
  echo "Error creating table: " . $conn->error.'<br>';
}

//inclusão de clientes
$sql = "INSERT INTO titulos_pagar (id_fornecedor, valor,pago,saldo,data_emissao,data_pagamento) VALUES ('1','100','10','90','2023-03-01','2023-03-10')";

if ($conn->query($sql) === TRUE) {
  echo "Inserir titulos_pagar feito successfully".'<br>';
} else {
  echo "Error creating table: " . $conn->error.'<br>';
}
